...
shisamap = np.ones((447, 370),dtype=uint8)
...
for j in range(20, 25):
    for k in range(20, 25):
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+1, n+1] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+1, n+2] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+1, n+3] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+1, n+4] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+1, n+5] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+1, n+6] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+1, n+7] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+2, n+1] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+2, n+2] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+2, n+3] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+2, n+4] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+2, n+5] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+2, n+6] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+2, n+7] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+3, n+1] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+3, n+2] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+3, n+3] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+3, n+4] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+3, n+5] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+3, n+6] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+3, n+7] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+4, n+1] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+4, n+2] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+4, n+3] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+4, n+4] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+4, n+5] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+4, n+6] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+4, n+7] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+5, n+1] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+5, n+2] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+5, n+3] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+5, n+4] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+5, n+5] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+5, n+6] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+5, n+7] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+6, n+1] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+6, n+2] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+6, n+3] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+6, n+4] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+6, n+5] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+6, n+6] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+6, n+7] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+7, n+1] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+7, n+2] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+7, n+3] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+7, n+4] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+7, n+5] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+7, n+6] = uint8(shisa*8)
        ...
        for i in range(0, 32):
            shisa += i * dense1_output[0, i]
        print(shisa)
        shisamap[m+7, n+7] = uint8(shisa*8)
...
img = Image.fromarray(shisamap, 'L')
img.save('my.png')
