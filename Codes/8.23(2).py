...
concatenated1 = Concatenate(axis=1, name='concatenated1')([shisasum11, shisasum12, shisasum13, shisasum14, shisasum15, shisasum16, shisasum17, shisasum18,
...
concatenated2 = Concatenate(axis=1, name='concatenated2')([wavelet_LL, wavelet_HH, wavelet_HL, wavelet_LH, wavelet_NHH, wavelet_NHL, wavelet_NLH, wavelet_NLL])
...
model1 = Model([main_input11, main_input12, main_input13, main_input14, main_input15, main_input16, main_input17, main_input18,
                main_input21, main_input22, main_input23, main_input24, main_input25, main_input26, main_input27, main_input28,
                main_input31, main_input32, main_input33, main_input34, main_input35, main_input36, main_input37, main_input38,
                main_input41, main_input42, main_input43, main_input44, main_input45, main_input46, main_input47, main_input48,
                main_input51, main_input52, main_input53, main_input54, main_input55, main_input56, main_input57, main_input58,
                main_input61, main_input62, main_input63, main_input64, main_input65, main_input66, main_input67, main_input68,
                main_input71, main_input72, main_input73, main_input74, main_input75, main_input76, main_input77, main_input78,
                main_input81, main_input82, main_input83, main_input84, main_input85, main_input86, main_input87, main_input88],
               [main_layer113, side_layer113, main_layer123, side_layer123, main_layer133, side_layer133, main_layer143, side_layer143, main_layer153, side_layer153, main_layer163, side_layer163, main_layer173, side_layer173, main_layer183, side_layer183,
                main_layer213, side_layer213, main_layer223, side_layer223, main_layer233, side_layer233, main_layer243, side_layer243, main_layer253, side_layer253, main_layer263, side_layer263, main_layer273, side_layer273, main_layer283, side_layer283,
                main_layer313, side_layer313, main_layer323, side_layer323, main_layer333, side_layer333, main_layer343, side_layer343, main_layer353, side_layer353, main_layer363, side_layer363, main_layer373, side_layer373, main_layer383, side_layer383,
                main_layer413, side_layer413, main_layer423, side_layer423, main_layer433, side_layer433, main_layer443, side_layer443, main_layer453, side_layer453, main_layer463, side_layer463, main_layer473, side_layer473, main_layer483, side_layer483,
                main_layer513, side_layer513, main_layer523, side_layer523, main_layer533, side_layer533, main_layer543, side_layer543, main_layer553, side_layer553, main_layer563, side_layer563, main_layer573, side_layer573, main_layer583, side_layer583,
                main_layer613, side_layer613, main_layer623, side_layer623, main_layer633, side_layer633, main_layer643, side_layer643, main_layer653, side_layer653, main_layer663, side_layer663, main_layer673, side_layer673, main_layer683, side_layer683,
                main_layer713, side_layer713, main_layer723, side_layer723, main_layer733, side_layer733, main_layer743, side_layer743, main_layer753, side_layer753, main_layer763, side_layer763, main_layer773, side_layer773, main_layer783, side_layer783,
                main_layer813, side_layer813, main_layer823, side_layer823, main_layer833, side_layer833, main_layer843, side_layer843, main_layer853, side_layer853, main_layer863, side_layer863, main_layer873, side_layer873, main_layer883, side_layer883, wavedense])
...
model1.compile(optimizer=adam,
               ...
               loss_weights={'main_layer113': alpha, 'side_layer113': beta, 'main_layer123': alpha, 'side_layer123': beta, 'main_layer133': alpha, 'side_layer133': beta, 'main_layer143': alpha, 'side_layer143': beta, 'main_layer153': alpha, 'side_layer153': beta, 'main_layer163': alpha, 'side_layer163': beta, 'main_layer173': alpha, 'side_layer173': beta, 'main_layer183': alpha, 'side_layer183': beta,
                             ...
                             'main_layer813': alpha, 'side_layer813': beta, 'main_layer823': alpha, 'side_layer823': beta, 'main_layer833': alpha, 'side_layer833': beta, 'main_layer843': alpha, 'side_layer843': beta, 'main_layer853': alpha, 'side_layer853': beta, 'main_layer863': alpha, 'side_layer863': beta, 'main_layer873': alpha, 'side_layer873': beta, 'main_layer883': alpha, 'side_layer883': beta, 'wavedense': gamma}
               )
...
model1.fit([input_grey, input_grey, input_grey, input_grey, input_grey, input_grey, input_grey, input_grey,
            ...
            input_grey, input_grey, input_grey, input_grey, input_grey, input_grey, input_grey, input_grey,
            input_grey, input_grey, input_grey, input_grey, input_grey, input_grey, input_grey, input_grey,],
           [target_pixel11_100, target_side_100, target_pixel12_100, target_side_100, target_pixel13_100, target_side_100, target_pixel14_100, target_side_100, target_pixel15_100, target_side_100, target_pixel16_100, target_side_100, target_pixel17_100, target_side_100, target_pixel18_100, target_side_100,
            target_pixel21_100, target_side_100, target_pixel22_100, target_side_100, target_pixel23_100, target_side_100, target_pixel24_100, target_side_100, target_pixel25_100, target_side_100, target_pixel26_100, target_side_100, target_pixel27_100, target_side_100, target_pixel28_100, target_side_100,
            target_pixel31_100, target_side_100, target_pixel32_100, target_side_100, target_pixel33_100, target_side_100, target_pixel34_100, target_side_100, target_pixel35_100, target_side_100, target_pixel36_100, target_side_100, target_pixel37_100, target_side_100, target_pixel38_100, target_side_100,
            target_pixel41_100, target_side_100, target_pixel42_100, target_side_100, target_pixel43_100, target_side_100, target_pixel44_100, target_side_100, target_pixel45_100, target_side_100, target_pixel46_100, target_side_100, target_pixel47_100, target_side_100, target_pixel48_100, target_side_100,
            target_pixel51_100, target_side_100, target_pixel52_100, target_side_100, target_pixel53_100, target_side_100, target_pixel54_100, target_side_100, target_pixel55_100, target_side_100, target_pixel56_100, target_side_100, target_pixel57_100, target_side_100, target_pixel58_100, target_side_100,
...
print(iml[m, n, ], iml[m, n+1, ], iml[m, n+2, ], iml[m, n+3, ],iml[m, n+4, ], iml[m, n+5, ], iml[m, n+6, ], iml[m, n+7, ])
print(iml[m+1, n, ], iml[m+1, n+1, ], iml[m+1, n+2, ], iml[m+1, n+3, ],iml[m+1, n+4, ], iml[m+1, n+5, ], iml[m+1, n+6, ], iml[m+1, n+7, ])
print(iml[m+2, n, ], iml[m+2, n+1, ], iml[m+2, n+2, ], iml[m+2, n+3, ],iml[m+2, n+4, ], iml[m+2, n+5, ], iml[m+2, n+6, ], iml[m+2, n+7, ])
print(iml[m+3, n, ], iml[m+3, n+1, ], iml[m+3, n+2, ], iml[m+3, n+3, ],iml[m+3, n+4, ], iml[m+3, n+5, ], iml[m+3, n+6, ], iml[m+3, n+7, ])
print(iml[m+4, n, ], iml[m+4, n+1, ], iml[m+4, n+2, ], iml[m+4, n+3, ],iml[m+4, n+4, ], iml[m+4, n+5, ], iml[m+4, n+6, ], iml[m+4, n+7, ])
print(iml[m+5, n, ], iml[m+5, n+1, ], iml[m+5, n+2, ], iml[m+5, n+3, ],iml[m+5, n+4, ], iml[m+5, n+5, ], iml[m+5, n+6, ], iml[m+5, n+7, ])
print(iml[m+6, n, ], iml[m+6, n+1, ], iml[m+6, n+2, ], iml[m+6, n+3, ],iml[m+6, n+4, ], iml[m+6, n+5, ], iml[m+6, n+6, ], iml[m+6, n+7, ])
print(iml[m+7, n, ], iml[m+7, n+1, ], iml[m+7, n+2, ], iml[m+7, n+3, ],iml[m+7, n+4, ], iml[m+7, n+5, ], iml[m+7, n+6, ], iml[m+7, n+7, ])
